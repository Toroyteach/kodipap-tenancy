...
class SettingSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'sms_partial_payment', 'value' => 'Hi :name, you have made a partial payment of'],
            ['key' => 'sms_overdue_notice', 'value' => 'Your rent is overdue. Please clear your balance'],
            ['key' => 'sms_welcome_tenant', 'value' => 'Welcome :name! Your lease at :property starts on :date. Thank you for choosing us.'],
